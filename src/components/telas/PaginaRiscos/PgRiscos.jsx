...
import { BotaoNovoItem, BotaoEditarItem, BotaoVisualizarItem, BotaoDeletarItem, BotaoCriar, BotaoCancelar } from '../../shared/template/Botoes';
        ...
        <DivConteudo>
         ...
         <br/> 
            <div style={{ height: 450, width: "100%", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)", border: "2px solid #C7C7C7", borderRadius: "8px" }}>
                <DataGrid rows={rowsRiscos} columns={columnsRiscos} localeText={GRID_DEFAULT_LOCALE_TEXT} pageSize={5} GridToolbarExport GridFilterForm components={{Toolbar: CustomToolbar,}} onRowSelected={(e) => itemSelecionado = e.data} onCellDoubleClick={() => abrirVisualizar()}/>
            </div>
